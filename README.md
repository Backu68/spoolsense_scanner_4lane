...
**C5/C6 display support:** These targets support the I2C LCD but not TFT or keypad. Their single general-purpose SPI bus is reserved for the NFC reader; safe TFT support requires a future shared-bus implementation.
